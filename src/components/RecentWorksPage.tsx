...
export function RecentWorksPage({ onLogoClick }: RecentWorksPageProps) {
    ...
    <div className="saved-items-page">
      ...
      <div className="container">
        ...
        {!error && recentItems.length === 0 && (
          <EmptyState
            icon="🆕"
            title="Nessuna opera recente"
            description="Non ci sono ancora opere da mostrare. Torna più tardi per scoprire le ultime opere pubblicate dalla community."
            action={
              <button
