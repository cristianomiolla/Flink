...
interface AppointmentCardProps {
  ...
  showParticipants?: boolean // Show participant details in overlay
}

export function AppointmentCard({ bookingId, isFromCurrentUser, timestamp, mode = 'message', participantName, cardType, refreshTrigger, onBookingUpdated, showParticipants = false }: AppointmentCardProps) {
  ...
  const cardContent = (
    <div
      className={`appointment-card ${mode === 'appointment' ? 'clickable' : ''}`}
              ...
              {isArtistAppointment ? (
                ...
                <>
                  ...
                  {fullBookingData.total_amount && (
                    <div className="booking-field">
                      <span className="field-label">Prezzo Totale:</span>
                      <span className="field-value budget">€{fullBookingData.total_amount}</span>
                    </div>
                  )}
                  ...
                  {fullBookingData.deposit_amount && (
                    <div className="booking-field">
                      ...
                      <span className="field-value budget deposit">€{fullBookingData.deposit_amount}</span>
                    </div>
                  )}
